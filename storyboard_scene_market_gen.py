...
PROPS += [
    ...
    # 장대는 양 끝 2본. 가운데 것은 무대 앞을 가려 뺐다.
    # 차양 y 범위(-1.0~4.0) 안쪽으로 당겨 세워 걸치는 폭을 줄인다.
    ("chayang_pole_a", "cylinder", (-2.9, 0.0, 1.55), (0.09, 0.09, 3.1), 0,
     "차양 바깥 모서리를 받친 대나무 장대"),
    ("chayang_pole_c", "cylinder", (-2.9, 3.0, 1.6), (0.09, 0.09, 3.2), 0,
     "차양 바깥 모서리를 받친 대나무 장대"),
